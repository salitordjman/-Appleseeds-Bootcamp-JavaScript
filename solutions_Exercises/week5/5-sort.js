...
const descendingToAscending=(arr)=>{
  let newOrder=arr.sort((a, b) => a - b);
  return newOrder
}
console.log(descendingToAscending(numbers));

//!22222222222222222222222222222222222222222

const ascendingToDescending=(arr)=>{
  let newOrder1=arr.sort((a, b) => b - a);
  return newOrder1
}
console.log(ascendingToDescending(numbers));
...
console.log(ratingHighToLow(movies));
