...
const greaterThan=(num,arr)=>{
  const endres=arr.find((el)=>el>num);
  return endres
}
console.log(greaterThan(10,numbers));
...
const fruitName=(arr,namef)=>{
  const objfr=arr.find((el)=>el.name===namef);
  return objfr
}
console.log(fruitName(inventory,"apples"));
//!333333333333333333333333333333333333333333

const findId=(arr,id)=>{
  const objid=arr.find((el)=>el.id===id);
  return objid
}
console.log(findId(movies,3));
